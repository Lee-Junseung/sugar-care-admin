...
export function MealPatternStats() {
  ...
  return (
    <div className="space-y-5">
      <div className="mb-5">
        <h2 className="text-ink-900 mb-2">식사 기록 패턴 분석</h2>
        <p className="text-ink-500">사용자들의 식사 기록 행동을 분석합니다</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-card border border-ink-100 hover:shadow-card-hover transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-ink-500">총 기록 수</p>
          </div>
          <p className="text-ink-900">{totalRecords.toLocaleString()}건</p>
          <p className="text-ink-500 mt-1">최근 30일</p>
        </div>
        <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-card border border-ink-100 hover:shadow-card-hover transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-2">
            <Clock className="w-5 h-5 text-orange-500" />
            <p className="text-ink-500">피크 시간대</p>
          </div>
          <p className="text-ink-900">{peakHour.hour}</p>
          <p className="text-ink-500 mt-1">{peakHour.count}건 기록</p>
        </div>
        <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-card border border-ink-100 hover:shadow-card-hover transition-shadow duration-200">
          <div className="flex items-center gap-3 mb-2">
            <TrendingUp className="w-5 h-5 text-brand-600" />
            <p className="text-ink-500">월간 성장률</p>
          </div>
          <p className="text-ink-900">+15.4%</p>
          <p className="text-ink-500 mt-1">전월 대비</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* 시간대별 식사 기록 빈도 */}
        <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-card border border-ink-100 hover:shadow-card-hover transition-shadow duration-200">
          <h3 className="text-ink-900 mb-4">시간대별 식사 기록 빈도</h3>
          ...
          <div className="mt-4 grid grid-cols-3 gap-4">
            <div className="text-center p-3 bg-orange-50 rounded-xl border border-orange-200/50">
              ...
              <p className="text-ink-900 font-medium">48건</p>
            </div>
            <div className="text-center p-3 bg-blue-50 rounded-xl border border-blue-200/50">
              ...
              <p className="text-ink-900 font-medium">117건</p>
            </div>
            <div className="text-center p-3 bg-purple-50 rounded-xl border border-purple-200/50">
              ...
              <p className="text-ink-900 font-medium">85건</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-card border border-ink-100 hover:shadow-card-hover transition-shadow duration-200 flex flex-col">
          <h3 className="text-ink-900 mb-4 flex-none">월별 사용 트렌드</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-indigo-50 rounded-2xl p-4 sm:p-5 shadow-card border border-indigo-100">
          <h3 className="text-ink-900 mb-2">가장 활발한 요일</h3>
          <p className="text-ink-900 mb-1">월요일</p>
          <p className="text-ink-500">352건 기록</p>
        </div>
        <div className="bg-orange-50 rounded-2xl p-4 sm:p-5 shadow-card border border-orange-100">
          <h3 className="text-ink-900 mb-2">평균 일일 기록</h3>
          <p className="text-ink-900 mb-1">259건</p>
          <p className="text-ink-500">사용자 1인당 1.8건</p>
        </div>
        <div className="bg-brand-50 rounded-2xl p-4 sm:p-5 shadow-card border border-brand-100">
          <h3 className="text-ink-900 mb-2">AI 선호도</h3>
          <p className="text-ink-900 mb-1">증가 추세</p>
          <p className="text-ink-500">주초에 더 많이 사용</p>
        </div>
      </div>
    </div>
  );
